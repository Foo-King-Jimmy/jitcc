...
// JJX  ! Enable here:  GDEBUG, BCHECK, BACKTRACE  !

// JJX  NOT NOW:  #define CONFIG_TCC_GDEBUG
#if defined TCC_IS_NATIVE && !defined CONFIG_TCCBOOT
// JJX  NOT NOW:  # define CONFIG_TCC_BACKTRACE
# if (defined TCC_TARGET_I386 || defined TCC_TARGET_X86_64) && !defined TCC_UCLIBC && !defined TCC_MUSL
// JJX  NOT NOW:  # define CONFIG_TCC_BCHECK
# endif                                       /* enable bound checking code */
#endif
// JJX                                        /* also enable -g , its implication */
#if defined CONFIG_TCC_BCHECK && !defined CONFIG_TCC_GDEBUG
# define CONFIG_TCC_GDEBUG
#endif
...
#ifndef LIBTCCAPI
# define LIBTCCAPI  static    /** JJX became static here **/
#endif
...
# define PUB_FUNC   static  /** JJX became static here  **/
#endif

#ifndef ONE_SOURCE
# define ONE_SOURCE   1   // JJX  defd ONE_SOURCE here => make ST_... static
#endif
...
struct TCCState {
    ...
    FILE *jjdbgfh;  /* debug-file-handle for error/warning/bench/verbose */

    int verbose; /* if true, display some information during compilation */
    // JJX  Extra/Control this in top func:   int nostdinc; /* if true, no standard headers are added */
    // JJX  Extra/Omitted for now:            int nostdlib; /* if true, no standard libraries are added */
    ...
    int no_alacarte_link; /* if false, only link in referenced objects from archive */
    ...
    /* error handling */
    // JJX  omitted for now:    void *error_opaque;
    // JJX  omitted for now:    void (*error_func)(void *opaque, const char *msg);
    int      nb_errors;
    ...
    // JJX  eliminated:  int argc;
    // JJX  eliminated:  char **argv;
};
